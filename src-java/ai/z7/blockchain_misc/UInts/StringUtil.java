...
import static ai.z7.blockchain_misc.UInts.Arrays.LONG;

/**
 * These constants are basically ripped from OpenJDK.
 */
final class StringUtil {
  private static final int[] BITS_PER_DIGIT = {
  ...
  private static final long[] RADIX_LONG = {
  ...
  static int[] fromString(final String s, final int radix, final int maxWidth) {
    ...
    final long bits  = (((long) digits * BITS_PER_DIGIT[radix - 2]) >>> 10) + 1;
